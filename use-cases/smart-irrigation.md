...
description: Irrigation management, fields provision and data visualization with IoT Hub IoT Platform
notitle: "true"
...
The diagram below identifies data flow and integration points for a typical smart irrigation monitoring solution that uses the IoT Hub platform to collect and analyze monitoring data from sensors.
...
<div class="usecases-bottom-nav">
    ...
    <a id="UseCases_SmartIrrigation_ContactUs" href="https://www.magenta.at/business/iot/kontakt" class="button gtm_button">Contact us</a>
</div>
