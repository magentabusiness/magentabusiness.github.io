...
description: IoT smart office solutions with IoT Hub
notitle: "true"
...
IoT Hub platform dramatically reduces time to market and efforts to create smart office solutions.
...
Smart Office [template](/docs/paas/solution-templates/smart-office/) represents a basic work space monitoring and management solution. 
...
The live dashboard is part of the [solution template](/docs/paas/solution-templates/smart-office/) 
and displays office floor plan and data from various IoT sensors that is collected using IoT Hub MQTT API.
...
The diagram below identifies data flow and integration points for a typical smart office solution that uses the IoT Hub platform to collect and analyze data from IoT sensors.
