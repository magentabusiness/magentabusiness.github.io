...
description: Waste management of garbage containers, data visualization, and device management with the IoT Hub IoT Platform
notitle: "true"
...
The diagram below identifies data flow and integration points for a typical waste management solution that uses the IoT Hub platform to collect and analyze monitoring data from waste sensors.
...
<div class="usecases-bottom-nav">
    ...
    <a id="UseCases_WasteManage_ContactUs" href="https://www.magenta.at/business/iot/kontakt" class="button gtm_button">Contact us</a>
</div>
