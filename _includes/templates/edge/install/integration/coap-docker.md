...
Execute the following command to create volume for the integration logs (_799 is the user id of IoT Hub non-root docker user_):
...
- **-v ~/.tb-pe-coap-integration-logs:/var/log/tb-coap-integration:** Mounts the host's dir **~/.tb-pe-coap-integration-logs** to IoT Hub remote integration logs directory.
