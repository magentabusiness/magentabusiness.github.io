...
- **-v ~/.tb-pe-http-integration-logs:/var/log/tb-http-integration:** Mounts the host's dir **~/.tb-pe-http-integration-logs** to IoT Hub remote integration logs directory.
