...
services:
  mytbedge:
    ...
    environment:
      ...
      CLOUD_RPC_HOST: PUT_YOUR_CLOUD_IP # e.g. host.docker.internal, 192.168.1.1 or iothub.magenta.at, etc.
      CLOUD_RPC_SSL_ENABLED: 'false' # set it to 'true' if you are connecting edge to iothub.magenta.at
      TB_QUEUE_TYPE: "kafka"
