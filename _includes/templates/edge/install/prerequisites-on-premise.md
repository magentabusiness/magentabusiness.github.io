...
You can install the **IoT Hub {{appPrefix}}** local server. For this, please refer to the [ThingsBoard installation guide](/docs/user-guide/install/{{peDocsPrefix}}installation-options/){:target="_blank"}. 
