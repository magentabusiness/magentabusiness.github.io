...
* [ThingsBoard Cloud (Europe)](https://eu.thingsboard.cloud/signup){: target="_blank"} or the **IoT Hub Community Edition** [local server](/docs/user-guide/install/installation-options/){: target="_blank"} as an alternative.
