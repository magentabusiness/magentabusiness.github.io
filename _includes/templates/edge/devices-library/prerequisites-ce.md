...
* [ThingsBoard Demo account](https://iothub.magenta.at/signup){: target="_blank"} or the **IoT Hub** [local server](/docs/user-guide/install/installation-options/){: target="_blank"} as an alternative.