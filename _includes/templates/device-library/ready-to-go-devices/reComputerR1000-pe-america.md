...
{% assign copyYmlPE = '
    ===
        ...
        title: Go to the **Edge management > Instances** section of your IoT Hub account, and click on the **Instance** itself. Then, click the **"Install & Connect Instructions"** button.
    ===
