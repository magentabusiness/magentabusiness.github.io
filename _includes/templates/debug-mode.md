...
<br>Therefore, starting from version 3.9, IoT Hub stores all debug events for {{feature}} only during the first 15 minutes. After that, only failure events are retained. 
