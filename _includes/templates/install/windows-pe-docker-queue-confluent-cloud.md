...
You can update default Rule Engine queues configuration using UI. More about IoT Hub Rule Engine queues see in [documentation](/docs/{{docsPrefix}}user-guide/rule-engine-2-5/queues/).F
