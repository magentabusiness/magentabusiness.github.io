IoT Hub platform currently supports two type of messaging brokers for storing the messages and communication between IoT Hub services: In-memory and Kafka-based brokers.
