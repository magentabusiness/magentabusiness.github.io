...
| ... key                   | **Pressure**          | Telemetry name, that will sends to IoT Hub instance.                                                                                                                                                                              |
| ... value                 | **${press}**          | Simple JSON expression, uses for looking value in the incoming message, that will send to IoT Hub instance as value of key parameter.                                                                                             |
