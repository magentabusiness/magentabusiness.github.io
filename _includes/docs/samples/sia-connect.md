...
In this comprehensive guide, we will walk you through the process of connecting an OPC-UA device to the IoT Hub platform via SIA Connect. 

The [SIA Connect](https://sia-connect.com/){:target="_blank"} is a tool that enables this process. 
By connecting your OPC-UA device to the IoT Hub platform, you can monitor, control, and automate your devices in a highly scalable and flexible way. Stay tuned as we guide you step by step through this process.
...
Also, we need to download <b>MQTT</b> connector to establish connection with IoT Hub. The steps are as for downloading MQTT connector:
...
- One for IoT Hub - this instance will map data from the device instance, convert it to a suitable format, and send data to IoT Hub.
...
#### Adding IoT Hub instance

This instance will map data from the device instance, convert it to a suitable format, and send data to IoT Hub. To add a new instance, use follow these steps:
...
IoT Hub instance has been added.
...
- Click on the <b>"+ New mapping"</b> in the "<b>Mappings on IoT Hub</b>" section;
- For "<b>Sender Item</b>" select "<b>OPC-UA Device</b>" as instance and "<b>Temperature</b>" as "<b>Item</b>"; 
- For "<b>Receiver item</b>" select "<b>IoT Hub</b>" as "<b>Instance</b>" and "<b>Publish data</b>" as "<b>Item</b>"; 
...
Once you have successfully done all the steps above and SIA Connect has sent data, you can view it in the "Latest telemetry" tab of the device in your IoT Hub instance:

- Navigate to the "<b>Devices</b>" page of the "<b>Entities</b>" section of your <b>IoT Hub</b> instance;
...
For this purpose we need to create one more item in <b>IoT Hub</b> instance of the <b>SIA Connect</b>, like the following:

- Go to the "<b>Instance</b>" tab in the side menu and select "<b>IoT Hub</b>";
- Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;
- Fill in the input fields:
...
The next step is to create another mapping for data transmission between the IoT Hub instance and the OPC-UA Device. For this purpose, follow the steps below:

- On the <b>IoT Hub</b> instance, scroll down to "<b>Mappings</b>" section and click on "<b>+ New Mapping</b>" button;
- For "<b>Sender Item</b>" select "<b>IoT Hub</b>" as instance and "<b>Shared attribute update</b>" as "<b>Item</b>"; 
...
Finally, we need to create shared attribute on the device on IoT Hub platform. For this purpose, follow these steps:

- Go to the "<b>Devices</b>" page of the "<b>Entities</b>" section of your <b>IoT Hub</b> instance;
...
By following the instructions provided in this guide, you'll be able to effortlessly establish a connection between your OPC-UA device and the IoT Hub platform using SIA Connect. 
