...
It is equipped with WI-FI for easy configuration without the need for any additional configuration tools. By connecting this device to the IoT Hub, you can get improved visualization and data management capabilities.
