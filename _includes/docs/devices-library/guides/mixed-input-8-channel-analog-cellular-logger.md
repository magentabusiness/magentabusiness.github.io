...
In this guide, we will learn how to [create device on IoT Hub](#create-device-on-thingsboard).  
After this we will [configure and connect the device](#connect-device-to-thingsboard), and [check the data on IoT Hub](#check-data-on-thingsboard).  
...
- [IoT Hub account](https://{{hostName}})
