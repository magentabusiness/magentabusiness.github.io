...
- **IP domain name**: iothub.magenta.at (Note: if you deploy iot hub by yourself, fill in your own server IPdomainname)
- **Port**: 1883
...
- Login to your IoT Hub instance and go to the "Devices" page of the "Entities" section.
...
{% assign addDevice = '
    ===
        ...
        title: Login to your IoT Hub instance and go to the "Devices" page of the "Entities" section. Click on the "+" icon in the top right corner of the table and then select "Add new device" from drop-down menu.
    ===
