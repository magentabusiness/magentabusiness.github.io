...
After doing steps described in this guide you will have a connected and configured gateway on a network server and integration on IoT Hub, it will allow you to add devices, receive data from them and process a data.
