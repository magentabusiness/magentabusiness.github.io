...
You can use [IoT Hub](https://{{hostName}}/signup){:target="_blank"}
...
* [Step 1.4] Copy the access token, record it for gateway to connect to the IoT Hub.
...
* [Step 2.3] Fill in the credentials from the IoT Hub:
  * IoT Hub Server: **{{hostName}}**
  * Server Port: **1883**
...
* [Step 3.1] Check connection in the IoT Hub;
...
* [Step 3.1.3] Device is correctly registered to the IoT Hub server, and the oximeter data is received in the cloud;
