...
{% assign addIntegrationSteps = '
    ...
    ===
        ...
        title: Copy the created API key and save it, we will need it for integration on IoT Hub.
'%}
...
Next, we will create an integration with Chirpstack inside the IoT Hub and configure the integration on Chirpstack.
