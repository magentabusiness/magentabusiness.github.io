...
In order to get the state of the device from IoT Hub during booting we have functionality to do this in the code.
...
In order to give ability to our callbacks to receive the data we have to send a request to IoT Hub. This 
