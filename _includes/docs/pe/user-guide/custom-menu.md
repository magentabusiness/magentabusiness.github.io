...
Customizing menu in IoT Hub allows you to tailor the navigation menu to your needs, providing quick access to the most frequently used functions and dashboards.
...
To hide menu items in the IoT Hub user interface, switch the "Hidden/Visible" toggle to "Hidden" in the row of the menu item you want to hide.
...
{% assign hideExistingMenuItems = '
    ===
        ...
        title: To hide menu items in the IoT Hub user interface, switch the "Hidden/Visible" toggle to "Hidden" in the row of the menu item you want to hide. For example, hide the "Plan and Billing" and "Dashboards" menu items. Then save the changes;
    ===
