...
The [OPC-UA server](#prerequisites) simulates sending telemetry from devices to IoT Hub. If you have done everything correctly, 10 new devices should appear on the "**Devices**" page as a result of the integration. Please make sure of this.
