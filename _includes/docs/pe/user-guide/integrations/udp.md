...
{% if docsPrefix == "pe/" %}
- The instance of the [iothub.magenta.at](https://iothub.magenta.at){:target="_blank"} installed locally;
...
An uplink converter that is a script for parsing and transforming the data received by UDP integration to format that IoT Hub uses. 
