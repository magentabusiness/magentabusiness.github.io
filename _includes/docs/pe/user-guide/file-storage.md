...
IoT Hub has ability to store binary content (files) in the DataBase.
...
IoT Hub provides access to stored files via **Files** Widget which is part of **Files** Widgets Bundle.
