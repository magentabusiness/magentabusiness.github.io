...
This document provides step-by-step instructions for configuring the mail server in IoT Hub.
...
Starting from IoT Hub 3.5.2 we have added mail settings templates for such providers: [Sendgrid](#sendgrid-configuration-example), [Gmail](#gmail-configuration-with-basic-authentication-example) and [Office 365](#office-365-configuration-with-oauth2-authentication-example). 
