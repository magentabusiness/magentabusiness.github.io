...
IoT Hub System Administrator is able to configure a connection to a SMTP server that will be used to distribute activation and password reset emails to users.{% unless docsPrefix %}
...
Login to your IoT Hub instance WEB UI as a system administrator using default [**account**](/docs/samples/demo-account/#system-administrator).
...
Starting from IoT Hub 3.5.2 we have added mail settings templates for such providers: Google, Office 356, SendGrid. 
...
**ㅤ2. Setup IoT Hub mail server settings**

Now navigate to the "Settings" page -> "Mail Server" tab your IoT Hub instance and fill in the form:
...
Navigate to the "Settings" page -> "Mail Server" tab your IoT Hub instance and fill in the form:
...
Starting from IoT Hub 3.5.2 it is possible to use OAuth2 authorization for Gmail SMTP server. 
...
To use Gmail OAuth2 you need to create a project in Google Developers Console but first let's set up IoT Hub mail server settings.

**ㅤ1. Setup IoT Hub mail server settings**

- In your IoT Hub instance, go to the "Settings" page -> "Mail Server" tab;
- Fill in the "mail From" field;
- Select SMTP provider - "**Google**";
...
<br>
**ㅤ4. Complete IoT Hub settings setup**

Back to the IoT Hub portal and paste **Client ID** and **Client secret** from the previous steps into the appropriate fields. Click "Save".
...
Please follow the steps in your browser and after acceptance we will automatically save Refresh Token and Access Token and redirect you back to IoT Hub portal. 
...
Starting from IoT Hub 3.6 it is possible to use OAuth2 authorization for Office 365 SMTP server. 
...
To use Office 365 OAuth2 you need to register an application in the Azure portal but first let’s set up IoT Hub mail server settings.
...
<br>
**ㅤ5. Complete IoT Hub settings setup**:

Back to the IoT Hub portal and paste **Client ID**, **Client secret** and **Directory (tenant) ID** from the previous steps into the appropriate fields. Click "Save".
...
in your browser and after acceptance we will automatically save Refresh Token and Access Token and redirect you back to IoT Hub portal. 
If access token was successfully generated you will see status "generated".
