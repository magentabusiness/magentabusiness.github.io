...
IoT Hub System Administrator is able to configure SMS provider that will be used the SMS gateway to send text messages to your customers or users.
...
To configure SMS provider settings in IoT Hub, follow these steps:
