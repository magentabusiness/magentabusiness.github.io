...
There are system-level and tenant-level widget bundles. Initial IoT Hub installation comes with a basic set of system-level widget bundles.
...
The Edge widgets bundle is useful for an overview of entities related to the specified IoT Hub Edge instance.
