...
## Processing in isolated IoT Hub Rule Engine queues
...
This provides a better level of isolation for those tenants. You need to create tenant profile with enabled "Use isolated IoT Hub Rule Engine queues" box 
