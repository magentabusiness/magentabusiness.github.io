...
Now you may use the *ca-root.pem* to setup secure connection to your IoT Hub instance (*YOUR_TB_HOST*) and Access Token (*YOUR_ACCESS_TOKEN*) to authenticate the device to upload telemetry:
