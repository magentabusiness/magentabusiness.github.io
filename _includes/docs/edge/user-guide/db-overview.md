...
## Dashboard Provision to IoT Hub Edge

The dashboards can be created and managed on the **IoT Hub server**, and then [provisioned](/docs/{{docsPrefix}}getting-started/#step-5-provision-dashboard-to-thingsboard-edge){: target="_blank"} to the **Edge instance**. This approach enables the simultaneous deployment of changes to all Edge instances.
...
To **create** the Edge Dashboard on your **IoT Hub Edge** instance, do the following:
...
If you have multiple instances of **IoT Hub Edge**, you can delete the Dashboard on one of them *without affecting* it on the other instances. To delete the **Dashboard** from all **IoT Hub Edge** instances *at once*, delete it from your IoT Hub platform.

### Assign/Remove Customers

Before you assign customers to the Dashboard, make sure that you have assigned them to the **IoT Hub Edge** instance first. You can read more about Customers [here](/docs/{{cloudDocsPrefix}}user-guide/ui/customers/){: target="_blank"}.
