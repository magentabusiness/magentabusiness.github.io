...
A dashboard in IoT Hub allows users to visualize and monitor data collected from IoT devices.
...
In IoT Hub, you can&#39;t share an individual dashboard directly — you can only share a dashboard group that contains the dashboard you want to share.
...
If you have any questions about this sample, please [contact us - service4iot@magenta.at](mailto:service4iot@magenta.at).