...
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/telemetry
```
{: .copy-code}

Where
- **host** - the hostname or IP address your platform is running on;
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST --data "{"temperature":42,"humidity":73}" http://host/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @telemetry-data-as-object.json http://host/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @telemetry-data-as-array.json http://host/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @telemetry-data-with-ts.json http://host/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/attributes
```
{: .copy-code}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST --data "{"attribute1": "value1", "attribute2":true, "attribute3": 43.0}" http://host/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @new-attributes-values.json http://host/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2
```
{: .copy-code}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X GET http://host/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/attributes/updates
```
{: .copy-code}
...
{% if docsPrefix == "pe/" %}
```shell
curl -v -X GET http://host/api/v1/$ACCESS_TOKEN/attributes/updates?timeout=20000
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/rpc
```
{: .copy-code}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/rpc/{$id}
```
{: .copy-code}
...
```shell
curl -v -X GET http://host/api/v1/$ACCESS_TOKEN/rpc?timeout=20000
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @rpc-response.json http://host/api/v1/$ACCESS_TOKEN/rpc/1 --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
- Now, send request to the server using the command below. Don't forget to replace <code>host</code> with your host and <code>$ACCESS_TOKEN</code> with your device's access token:

```shell
curl -X POST -d @rpc-client-request.json http://host/api/v1/$ACCESS_TOKEN/rpc --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix contains "paas/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/$ACCESS_TOKEN/claim
```
{: .copy-code}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://host/api/v1/provision
```
{: .copy-code}

Where **host** - the hostname or IP address your platform is running on;
{% endif %}
{% if docsPrefix == null %}
If you use live demo server, the command will look like this:
