...
For more information about configuration possibilities and certificate generation, please review the following IoT Hub security [pages](/docs/user-guide/mqtt-over-ssl/).
