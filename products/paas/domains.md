...
white-labeling:
    ...
    1:
        ...
        title: 'Now you can use your domain name to access IoT Hub Web UI and services. Try to login by entering the chosen domain name in the browser address line.'
...
domainDetails:
    ...
    1:
        ...
        title: 'IoT Hub will automatically renew the certificate earlier than 30 days before it expires, no action is required from your part unless you change or delete the domain CNAME record.'
