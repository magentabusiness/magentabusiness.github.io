...
tb-endpoint-url:
  0:
    ...
    title: 'In your IoT Hub instance navigate to the "Integrations" page and opne HTTP integration details. Then enable debug mode and copy "HTTP endpoint URL".'
...
add-http-integration:
  ...
  3:
    ...
    title: 'In the field "Endpoint URL" paste the URL from the HTTP integration of your IoT Hub.'
  4:
...
http-integration-result:
  0:
    ...
    title: 'Open IoT Hub HTTP integration details page.'
  1:
