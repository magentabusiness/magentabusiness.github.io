...
assignees:
- ashvayka
title: Installing IoT Hub on CentOS/RHEL
description: Installing IoT Hub on CentOS/RHEL
...
This guide describes how to install IoT Hub on RHEL 8/9, CentOS 8/9, or their derivatives (Alma, Rocky, Oracle, etc). 
...
IoT Hub UI is accessible on 8080 port by default. 
...
## Step 9. Install IoT Hub WebReport component
