...
assignees:
- ashvayka
title: Installing IoT Hub on Ubuntu
description: Installing IoT Hub on Ubuntu
...
This guide describes how to install IoT Hub on Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS.
