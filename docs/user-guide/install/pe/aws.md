...
notitle: "true"
description: IoT Hub IoT platform  AWS cluster setup guide
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>IoT Hub Setup options on AWS</h1>
                <div class="install-options-description">
                    <p>
                        You may deploy IoT Hub IoT Platform using different tools and platforms
                    </p>
                </div>
            </div>
