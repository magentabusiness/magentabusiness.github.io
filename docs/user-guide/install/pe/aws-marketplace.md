...
Customers may still use <a href="https://iothub.magenta.at/" target="blank">IoT Hub</a> for that.
...
<p>Example A: The price for IoT Hub instance with Maker subscription plan based on t3.medium with 20 GB disk will cost approximately $42.4 per month:</p>
<ul>
...
<p>Example B: The price for IoT Hub instance with Prototype subscription plan based on m5.large with 100 GB disk will cost approximately $179 per month:</p>
<ul>
