...
title: Installing IoT Hub from GCP Marketplace
description: Installing IoT Hub from Google Cloud Platform Marketplace

---

This guide describes how to install IoT Hub from GCP Marketplace. 
Using this guide you will install bring-your-own-license (BYOL) version of the product.
Basically, you get the license directly from IoT Hub, Inc, but purchase corresponding server instances and infrastructure from GCP.       
...
### Step 1. Launch IoT Hub BYOL

Open [IoT Hub BYOL](https://console.cloud.google.com/marketplace/details/thingsboard-public/thingsboard-pe) product page on GCP Marketplace.
...
That's it! Your IoT Hub instance is now deploying! When complete you should see:
