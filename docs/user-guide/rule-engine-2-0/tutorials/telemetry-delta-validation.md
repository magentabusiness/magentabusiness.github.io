...
Let's assume we have a device that uses a temperature sensor to collect and read temperature readings in the IoT Hub.
...
Add Device entity in IoT Hub. Its name is **Thermometer** and its type is **temperature sensor**.
