...
title: GPS data upload and visualization using LinkIt ONE and IoT Hub
description: IoT Hub IoT Platform sample for GPS data upload and visualization using LinkIt ONE
...
After application will be uploaded and started it will try to connect to IoT Hub node using mqtt client and upload "latitude" and "longitude" attributes once per second.
