...
title: ESP32 Pico Kit GPIO control and DHT22 sensor monitor using IoT Hub Arduino SDK
description: IoT Hub IoT Platform sample for ESP32 Pico Kit GPIO control and temperature/humidity monitor using IoT Hub Arduino SDK
hidetoc: "true"
---
...
1. Find and install **IoT Hub Arduino SDK**, **PubSubClient by Nick O'Leary** and **ArduinoHttpClient** libraries.
...
- `THINGSBOARD_SERVER` - IoT Hub HOST/IP address that is accessible within your wifi network. Specify `iothub.magenta.at` if you are using [live demo](https://iothub.magenta.at/) server.
