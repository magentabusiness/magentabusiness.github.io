...
IoT Hub Cloud is for everyone who would like to use [ThingsBoard](/docs/{{docsPrefix}}getting-started-guides/what-is-thingsboard/) but don't want to host their own instance of the platform.
...
With **IoT Hub Cloud** you get the following benefits:
 ...
 - **High availability.** IoT Hub Cloud uses microservices architecture and is deployed in multiple availability zones.
