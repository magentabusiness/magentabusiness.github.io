...
google-configuration-of-thingsboard-google-1:
    0:
        ...
        title: 'Login to your EU IoT Hub account. Go to the "OAuth 2.0" page of the "Security" section. While on the "Domains" tab, click the "plus" icon;'
    1:
...
oauth0-configuration-of-thingsboard-1:
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-thingsboard/google-configuration-of-thingsboard-2-paas.png
        title: 'Enter your domain name of your EU IoT Hub instance. Click "Create new" in the "OAuth 2.0 clients" section to add a new one.'
...
keycloak-add-thingsboard-oauth-client-1:
    0:
        ...
        title: 'Login to your EU IoT Hub account. Navigate to the "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
