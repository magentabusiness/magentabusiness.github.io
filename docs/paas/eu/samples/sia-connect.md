...
creating-device-on-thingsboard:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/creating-opc-ua-device-1-paas.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/creating-opc-ua-device-2-paas.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/creating-opc-ua-device-3-paas.png
    ...
    3:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/creating-opc-ua-device-4-paas.png
    ...
    4:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/creating-opc-ua-device-5-paas.png
        title: 'Congratulations on adding the device!'

installing-sia-connect:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/installing-sia-connect-1-paas.png
        title: 'Go to the host, where the SIA Connect web UI is running.'

installing-opc-ua-connector:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/installing-opc-ua-connector-1-paas.png
...
installing-mqtt-connector:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/installing-mqtt-connector-1-paas.png
...
adding-opc-ua-device-instance-1:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-1-paas.png
        title: 'Go to "<b>Instance</b>" tab in the side menu and click "<b>+ Add new instance</b>" button;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-2-paas.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-3-paas.png
        title: 'OPC-UA Device instance added.'

adding-opc-ua-device-instance-2:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-4-paas.png
        title: 'Click on "<b>+ New item</b>" in the "<b>Items</b>" section;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-5-paas.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-6-paas.png
        title: 'You will now see the "<b>Temperature</b>" item added.'

adding-opc-ua-device-instance-3:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-opc-ua-device-instance-7-paas.png
        title: 'Add other items, such as "<b>Power</b>" and "<b>Humidity</b>".'

adding-thingsboard-instance-1:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-1-paas.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-2-paas.png
        title: 'IoT Hub instance has been added.'

adding-thingsboard-instance-2:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-3-paas.png
        title: 'Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-4-paas.png
...
adding-thingsboard-instance-3:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-5-paas.png
        title: 'Click on the "<b>+ New mapping</b>" in the "<b>Mappings on IoT Hub</b>" section;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-6-paas.png
...
adding-thingsboard-instance-4:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/adding-thingsboard-instance-7-paas.png
        title: 'Add other mappings, such as "<b>Power</b>" and "<b>Humidity</b>".'

check-data-on-thingsboard:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/check-data-on-thingsboard-1-paas.png
...
shared-attributes:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attributes-1-paas.png
        title: 'Go to the "<b>Instance</b>" tab in the side menu and select "<b>IoT Hub</b>";'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attributes-2-paas.png
        title: 'Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;'
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attributes-3-paas.png
...
status-attributes:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/status-attributes-1-paas.png
        title: 'Go to the "<b>Instance</b>" tab in the side menu and select <b>OPC-UA Device</b>;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/status-attributes-2-paas.png
        title: 'Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;'
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/status-attributes-3-paas.png
...
create-another-mapping:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/create-another-mapping-1-paas.png
        title: 'On the <b>IoT Hub</b> instance, scroll down to "<b>Mappings</b>" section and click on "<b>+ New Mapping</b>" button;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/create-another-mapping-2-paas.png
...
shared-attribute-on-device:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attribute-on-device-1-paas.png
    ...
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attribute-on-device-2-paas.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/shared-attribute-on-device-3-paas.png
        title: 'Shared attribute has been added.'

import-dashboard:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/import-dashboard-1-paas.png
        title: 'Go to the "<b>Dashboard</b>" page of your "<b>IoT Hub</b>" instance. will be redirected to the "<b>All</b>" device group. Click on the "<b>plus</b>" icon in the top right corner of the table and then select "<b>Import dashboard</b>" from drop-down menu;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/import-dashboard-2-paas.png
    ...
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/import-dashboard-3-paas.png
        title: 'You have successfully imported a dashboard. You should open it.'

change-entity-alias-1:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-1-paas.png
        title: 'Enter dashboard editing mode;'
    1:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-2-paas.png
        title: 'Click the "Entity aliases" icon;'
    2:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-3-paas.png
        title: 'In the opened "<b>Entity aliases</b>" window click the "<b>Edit alias</b>" icon opposite the "<b>OPC-UA Device</b>" alias;'
    3:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-4-paas.png
    ...
    4:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-5-paas.png
        title: 'Click "<b>Save</b>" in the lower right corner of the dialog box;'
    5:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-6-paas.png
        title: 'Save the dashboard.'

visualize-data-on-thingsboard:
    0:
        image: https://img.thingsboard.io/user-guide/integrations/sia-connect/change-entity-alias-7-paas.png
