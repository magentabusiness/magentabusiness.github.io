...
createFirmware:
    0:
        ...
        title: 'To create the OTA updates package on your IoT Hub server, navigate to the Advanced features > OTA updates section and click the "+" icon.'
    1:
...
verifyFirmware:
    0:
        ...
        title: 'Log in to the IoT Hub Edge instance, go to the Advanced features > OTA updates section and confirm that the firmware package has been successfully provisioned on the Edge instance.'
---
