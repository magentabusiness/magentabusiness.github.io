...
title: Configure white-labeling in IoT Hub Mobile Application
...
IoT Hub [white-labeling](/docs/pe/user-guide/white-labeling/) feature allows you to configure your company or product logo and color scheme.
In addition to the IoT Hub web interface, the white-label settings also apply to the IoT Hub Mobile app.
