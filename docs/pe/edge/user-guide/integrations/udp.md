...
assignIntegration:
    ...
    2:
        ...
        title: 'Login to your <b>IoT Hub Edge</b> instance and go to the <b>Integrations center > Integrations</b> section. Confirm the <b>UDP integration</b> on the <b>Edge</b>.'
...
- **UDP Integration:** The integration that runs externally and is connected to the **IoT Hub Edge** instance.
...
Once the **IoT Hub UDP Integration** has been created, the UDP server starts, and then it waits for data from the devices.
...
The example of the message sent to the device and the response from **IoT Hub Edge** in the terminal:
