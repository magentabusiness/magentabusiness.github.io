...
routeMessagesToCloud:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/1-rule-chain-templates-pe.webp
        title: 'Log in to the <b>IoT Hub Cloud</b> and go to the <b>Edge management > Rule chain templates</b> section and click on the <b>Rule chain</b> assigned to your <b>Edge instance.</b><ul><li>If you are using <b>Edge 4.0</b> or later, stay in your <b>Edge</b> instance and go to the <b>Rule chains</b> section. To edit a rule chain, click the appropriate <b>Rule Chain</b>.</li></ul>'
    1:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/2-add-push-to-cloud-pe.webp
    ...
    2:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/3-save-pe.webp
...
backToEdge:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/4-rule-chain-pe.webp
        title: 'Go to the <b>Rule Chains</b> section, to modify the <b>Rule Chain.</b>'
    1:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/5-add-script-pe.webp
    ...
    2:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/5-add-push-to-edge-pe.webp
    ...
    3:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/6-save-pe.webp
...
terminal:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/10-subscribe-post-update-attributes-mqtt-pe.webp
...
checkResultOnDevice:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/7-confirm-on-device-1-pe.webp
...
checkResultOnEdge:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/8-confirm-on-edge-node-1-pe.webp
    ...
    1:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/8-confirm-on-edge-node-2-pe.webp
...
checkResultOnCloud:
    0:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/9-confirm-on-cloud-node-1-pe.webp
    ...
    1:
        image: https://img.thingsboard.io/pe/edge/config/subscribe-to-attribute/9-confirm-on-cloud-node-2-pe.webp
