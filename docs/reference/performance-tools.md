...
description: IoT Hub IoT Platform data collection performance test tools
...
// provide device credential id as username during the connection phase to the IoT Hub server
val mqttConf = mqtt
...
We will share the results of IoT Hub IoT platform performance tests in the next post.
